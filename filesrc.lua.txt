...
spawn(function() 
    ...
    wait(1.5)
    require(game.ReplicatedStorage.Notification).new("<Color=Red>HIHUB chào ae<Color=/>"):Display()
    wait(.5)
    ...
    wait(.29)
    require(game.ReplicatedStorage.Notification).new("<Color=Yellow>flower tik tok hihublconcythe để có nhưng trải nhiệm vuii nhé :>><Color=/>"):Display()
    wait(.36)
end)

local OrionLib = loadstring(game:HttpGet(('https://raw.githubusercontent.com/shlexware/Orion/main/source')))()
local Window = OrionLib:MakeWindow({Name = "HIHUBICONCYTHE", HidePremium = false, IntroText = "HIHUBICONCYTHE ⚜️", SaveConfig = true, ConfigFolder = "NightHub"})
...
W:AddLabel("HIHUB SCRIPT")
W:AddLabel("DiscordHIHUB")
local Section = W:AddSection({
    Name = "Status"
})
